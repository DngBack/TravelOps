...
| **web_search** | [Tavily](https://tavily.com/) | — | `TAVILY_API_KEY` (lấy key tại [app.tavily.com](https://app.tavily.com/)) |

- **Web search:** Chỉ dùng Tavily. Dùng cho tool `web_search` và fallback tìm khách sạn khi không có Amadeus/HotelsAPI.
